    ...
    const submitForm = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.post("/dashboard/sections/" + sectionID, form);
            }
        });
    };
</script>
    ...
    <div class="w-full max-w-full px-3 mt-0 mb-6">
        ...
        >
            ...
            <div class="p-6">
                ...
                <div class="flex justify-end items-center gap-x-4 mb-12">
                    <button
                        on:click={submitForm}
